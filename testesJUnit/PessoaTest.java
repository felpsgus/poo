...
public class PessoaTest {
	...
	public void testFaixa1() {
		...
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("maria", 1500.00, 1, 50);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("maria", 1500.00, 0, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("maria", 1500.00, 2, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);
	...
	public void testFaixa2() {
		...
		assertEquals(15.91, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("joão", 2000.00, 2, 50);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("joão", 2000.00, 0, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("joão", 2000.00, 2, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);
	...
	public void testFaixa3() {
		...
		assertEquals(189.97, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 3500.00, 1, 20);
		assertEquals(10.26, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 3500.00, 2, 40);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("paulo", 3500.00, 0, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("paulo", 3500.00, 2, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);
	...
	public void testFaixa4() {
		...
		assertEquals(387.04, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 4400.00, 1, 30);
		assertEquals(207.33, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 4400.00, 2, 40);
		assertEquals(27.62, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 4400.00, 3, 20);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("paulo", 4400.00, 0, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("paulo", 4400.00, 2, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);
	...
	public void testFaixa5() {
		...
		assertEquals(1098.85, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("jose", 7000.00, 2, 30);
		assertEquals(739.43, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 7000.00, 6, 40);
		assertEquals(20.59, p.calculaImposto(p.getSalario()), 0.1);

		p = new Pessoa("paulo", 7000.00, 7, 20);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("paulo", 7000.00, 0, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);

		p = new Pessoa("paulo", 7000.00, 2, 66);
		assertEquals(0, p.calculaImposto(p.getSalario()), 0);
